...
// TODO: Re-factor these 'box' functions.
    ...
    var private_boxZoom_mouseUp = function ( e ) {
        var mapHalfWidthPoint  = this.resizedMapWidth  / 2 + this.mapContainer._left,
            ...
            centerPointOfBox = {
                x: ( widthOfBox / 2 )  + boxZoom.start.clientX + this.mapContainer._left,
                y: ( heightOfBox / 2 ) + boxZoom.start.clientY + this.mapContainer._top
            };
        ...
        this.tempTransformText = 'translate('+ this._left +'px,'+ this._top  +'px)';
    ...
    var boxZoom_doTheZoom = function ( arg_zoomBox ) {
        ...
        var XcoordOnMapImg = ( arg_zoomBox.x - this.mapContainer._left ) - this._left,
            YcoordOnMapImg = ( arg_zoomBox.y - this.mapContainer._top )  - this._top,
