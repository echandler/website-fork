...
// TODO: Re-factor these 'box' functions.
    ...
    var boxZoom_doTheZoom = function (arg_zoomBox) {
        ...
        var heightRatioOfBoxToMap = arg_zoomBox.height / this._height,
            widthRatioOfBoxToMap  = arg_zoomBox.width  / this._width;

        var tempWidth  = (this._width  * 2) * widthRatioOfBoxToMap, // this._width * 2 is used to simulate the next zoom.
            tempHeight = (this._height * 2) * heightRatioOfBoxToMap;// this._height * 2 is used to simulate the next zoom.

        if (tempWidth  > this.resizedMapWidth  || tempHeight > this.resizedMapHeight ||
            this.sliderPosition === 0) {

            this.zoom_module.zoomStart(
                (arg_zoomBox.x - this.mapContainer._left - this.dragDiv._left - this._left),
