...
DrawSVGLine_module = function( arg_theMap ){
...
DrawSVGLine_module.prototype.createNewPolyline = function( e ){
    ...
    this.SVGContainer.insertBefore( this.polyline, this.SVGContainer.firstElementChild );
    this.SVGContainer.appendChild( this.polyline.startPoint );
    this.mouseMoveHandler = function( e ){
        this.theMap.private_lasteClientX = e.clientX;//TODO: private_ needs to be replaced.
        this.theMap.private_lasteClientY = e.clientY;//TODO: private_ needs to be replaced.
        if( this.drawingALine && !this.theMap.state.panning ){
            this.polyline.setAttribute( 'points', this.polyline.currentPointsString +' '+ ( e.clientX - this.theMap.mapContainer._left - this.theMap.dragDiv._left ) +','+ ( e.clientY - this.theMap.mapContainer._top - this.theMap.dragDiv._top  ) );
        }
    }.bind( this );
    ...
    DrawSVGLine_module.prototype.bindSVGContainerClickHandlerTo_this = function(){
        return function( e ){
            ...
            if( this.clientX !== e.clientX && this.clientY !== e.clientY ){ return false; }
    ...
    DrawSVGLine_module.prototype.resizeOneLine = function( arg_line ){
        ...
        if( arg_line.endPoint ){ // Don't follow the mouse.
            ...
            arg_line.setAttribute( 'points', arg_line.currentPointsString + ' '+ this.theMap.private_lasteClientX +','+ this.theMap.private_lasteClientY );
        }
    };

    DrawSVGLine_module.prototype.bindSVGContainerDeleteLastVertexTo_this = function( e ){
        return  function( e ){
            var code = undefined;
            ...
            if( this.drawingALine ){
                ...
                if ( code == 8 || code == 46 ){// 8 = Backspace, 46 = Delete.
                    if( this.polyline.currentPointsArray.length > 1 ){
                        ...
                        this.polyline.currentPointsString = this.polyline.currentPointsArray.join( ' ' );
                        this.polyline.setAttribute( 'points', this.polyline.currentPointsString + this.polyline.getAttribute( 'points' ).replace(/.*( .+ ?)$/, '$1' ) );
                    }
                }
            }
            return false;
    ...
    DrawSVGLine_module.prototype.drawLineSetup = function(){
        ...
        if( this.drawLineOptionsCheckMark.checkedState() ){
            this.theMap.utilities_module.simpleMessageBox(
            ...
            if( this.drawingALine ){
                ...
                if( this.polyline.currentPointsArray.length === 1 ){
                    ...
                    this.polyline.endPoint = this.createEndPoint( { clientX: +this.polyline.currentPointsArray[this.polyline.currentPointsArray.length-1].split( ',' )[0], clientY: +this.polyline.currentPointsArray[this.polyline.currentPointsArray.length-1].split( ',' )[1] } );
