MeasureSvgLine_module = function( arg_theMap, arg_button ){
    ...
    obj.FeetDiv = function( arg_polyline, arg_lastPointBoolean, arg_index ){
        ...
        this.theMap.calculateMarkerPosition( feetDiv );
        return feetDiv;
    };
        ...
        if( OKToMakeFeetDiv ){
            ...
            if( feetDiv ){
                ...
                setTimeout(function(){
                    ...
                    this.thisPointer.theMap.calculateMarkerPosition( feetDiv );
                }.bind( this ), 10 );
        ...
        return function( e ){
            ...
            if( this.doubleClickA ){
                if( this.polyline.feetDivsArray.length > 1 ){
                    this.polyline.feetDivsArray[this.polyline.feetDivsArray.length-1].innerHTML = this.polyline.feetDivsArray[this.polyline.feetDivsArray.length-1].innerHTML +'<br><div style="color: grey; margin-top: 5px; font-style:italic;">'+ this.calculateTotalFeet( this.polyline.feetDivsArray ).toString( ).replace(/\B(?=(\d{3})+(?!\d))/g, ',' ) + ' ft</div>';
                }
                setTimeout(function(){
                ...
                this.theMap.calculateMarkerPosition( this.polyline.feetDivsArray[this.polyline.feetDivsArray.length-1] )
    ...
    obj.resizeLines = function(){
        ...
        for( var i = 0; i < linesArray.length; ++i ){
            ...
            while( index < linesArray[i].feetDivsArray.length ){// position the feetDiv's.
                ...
                this.theMap.calculateMarkerPosition( linesArray[i].feetDivsArray[index] );
                ++index;
            }
        }
    }
    ...
    obj.SVGContainerDeleteLastVertex = (function( e ){
        return function( e ){
            var code = undefined,
                polyline = undefined,
