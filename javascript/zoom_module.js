...
a.addEventListener("mousewheel",function (c) {var a=void 0,d=void 0,b=void 0,b=this.parentElement.getBoundingClientRect(),d=c.wheelDelta?c.wheelDelta:(a=window.event||c,-120*a.detail),a=c.clientX-b.left,b=c.clientY-b.top;c.preventDefault();120<=d?(d=a-e.width/2,b-=e.height/2,this.tempCSSTransformString="translate("+(0-d)+"px,"+(0-b)+"px) scale(2)"+this.tempCSSTransformString):-120>=d&&(d=(a-e.widt  2)/2,b=(b-e.heigh  2)/2,this.tempCSSTransformString="translate("+d+"px,"+b+"px) scale(0.5)"+this.tempCSSTransformString);
